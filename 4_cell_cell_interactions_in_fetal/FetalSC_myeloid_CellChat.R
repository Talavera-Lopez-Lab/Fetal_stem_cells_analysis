...
ad_object <- ad$read_h5ad("/Users/annamaguza/Desktop/CellChat/FetalSC_and_myeloid_cells_CellChat.h5ad")
...
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Number_of_interactions.png"
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Number_of_interactions_from_stem_cells.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Number_of_interactions_to_stem_cells.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Interaction_weights_strength.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Interaction_weights_strength_from_SCs.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Interaction_weights_strength_to_SCs.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
output_dir <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Incoming_pathways"
...
# Define the directory where the plots will be saved
output_dir <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Outgoing_pathways"
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Sankey_plot_outgoing.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Dot_plot_outgoing.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Enriched_outgoing_pathways.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Sankey_plot_incoming.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Dot_plot_incoming.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
...
# File path where the image will be saved
file_path <- "/Users/annamaguza/Desktop/Stem_cells_trajectory_analysis/4_cell_cell_interactions_in_fetal/figures/SC_myeloid/CellChat/Hierarchy_plot.png"
# Start the png device
png(filename = file_path, width = 3000, height = 3000, res = 300)
# Generate your plot
